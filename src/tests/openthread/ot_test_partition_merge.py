...
from src.tools import cambrionix
from src.utils import process_cleanup

from src.tools.wpan_util import verify_address, verify_prefix
...
class TestPartitionMerge(testcase.TestCase):
    ...
    def hardwareSelect(cls):
        cls.r1 = ffdb.ThreadNeedle()
        cls.r2 = ffdb.ThreadNeedle()
        cls.fed1 = ffdb.ThreadNeedle()
        cls.fed2 = ffdb.ThreadNeedle()
